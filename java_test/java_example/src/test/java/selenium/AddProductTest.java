...
public class AddProductTest {
    ...
    public void addProductTest() {
        ...
        File file = new File("src/test/java/files/elvis-duck.jpg");
        ...
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//input[@name='short_description[en]']")).sendKeys("Elvis Duck");
        driver.findElement(By.xpath("//div[@class='trumbowyg-editor']")).sendKeys("Elvis Duck");

        //Prices
        driver.findElement(By.xpath("//a[@href='#tab-prices']")).click();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//input[@name='purchase_price']")).sendKeys("11");
