...
public class CartOperationsTest {
    ...
    public void test() {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            // если в продукте есть выбор размера, то без его указания нельзя будет добавить продукт в корзину
            ...
            //ждем когда количество продуктов в корзине будет равно i
        ...
        //так как могло добавиться несколько одинаковых элементов, считаем количество позиций в корзине
