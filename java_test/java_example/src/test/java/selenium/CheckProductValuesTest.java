...
public class CheckProductValuesTest {
    ...
    public boolean checkBiggerValue(String bigger, String smaller) {
    ...
    public void checkProductValuesTest() {
        ...
        if (driver.findElement(By.className("content")).isDisplayed()) {
            ...
            Assert.assertEquals("rgba(119, 119, 119, 1)", productRegularPrice.getCssValue("color"));
            ...
            Assert.assertEquals("rgba(204, 0, 0, 1)", productCampaignPrice.getCssValue("color"));
            ...
            Assert.assertTrue(checkBiggerValue(
                    productCampaignPrice.getCssValue("font-size"),
                    productRegularPrice.getCssValue("font-size")
                    )
            );
